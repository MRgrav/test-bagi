...
<footer class="mt-9 max-sm:mt-10" style="background: #e0aaa2">
    ...
    <div class="flex justify-between bg-black/40 px-[60px] py-3.5 max-md:justify-center max-sm:px-5" style="background: #a1453;">
